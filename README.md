...
├── 首页/               ← 首页模块
│   ├── index.html
│   └── my-tasks.html       （我的任务，AI创作侧边栏入口）
│
├── AI 创作/            ← AI创作模块
│   ├── 通用生成.html
│   └── 图像素材衍生工作流.html  （首页常用功能-大字报裂变入口）
│
├── 素材管理/           ← 素材管理模块
│   ├── index.html           （素材库）
│   ├── 物料库.html
│   ├── 原料库.html          （占位页：混剪策略、模型配置、算力成本）
│   ├── category.html        （品类管理，AI创作侧边栏入口）
│   └── product.html         （产品管理，AI创作侧边栏入口）
│
└── 系统设置/           ← 系统设置模块（页面待开发，当前用原料库占位）
```
...
| 一级菜单 | 二级菜单 | 快捷入口（常用功能） |
|---------|---------|-------------------|
| 首页 | 首页 | 大字报裂变、素材库、AI通用生成 |
| AI创作 | 通用生成、品类管理、产品管理、我的任务 | — |
| 素材管理 | 素材库、物料库、混剪策略（暂不做） | — |
| 系统设置 | 模型配置、算力成本 | — |
