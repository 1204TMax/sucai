...
│   ├── image-preview.css/js  ← 图片预览系统
│   └── workflow-admin.css    ← ComfyUI 节点管理页面样式
│
├── 首页/               ← 首页模块
│   └── index.html
│
...
│   ├── 通用生成.html
│   ├── 我的任务.html        （菜单：我的任务）
│   ├── 全部结果-已成功.html     （任务成功结果页，非菜单页）
│   ├── 全部结果_等待中.html     （任务等待中/生成中结果页，非菜单页）
│   ├── 全部结果_部分失败.html   （任务部分失败结果页，非菜单页）
│   ├── 全部结果_全部失败.html   （任务全部失败结果页，非菜单页）
│   ├── 全部结果-正在生成:已中止.html （任务已中止结果页，非菜单页）
│   ├── 项目管理.html        （菜单：项目管理）
│   ├── ComfyUI 节点管理.html （菜单：ComfyUI 节点管理）
│   ├── 节点类型管理.html     （菜单：节点类型管理）
│   └── 工作流-裂变.html     （从通用生成-工作流卡片点击进入，非菜单页）
│
├── 素材管理/           ← 素材管理模块
│   ├── 素材库.html         （网格化素材列表，支持搜索/筛选/批量操作）
│   ├── 素材详情.html       （从素材库卡片点击进入，支持预览、编辑、数据分析）
│   ├── 物料库.html         （网格化物料列表，素材库的物料版）
│   ├── 物料详情.html       （从物料库卡片点击进入，素材详情的物料版）
│   ├── 上传素材.html       （非菜单页）
│   ├── 上传物料.html       （非菜单页）
│                            （手动合成→占位页）
│                            （自动合成→占位页）
...
|---------|---------|-------------------|
| 首页 | 首页 | 全部图片、AI通用生成 |
| AI创作 | 通用生成、我的任务、工作流广场、项目管理、ComfyUI 节点管理、节点类型管理 | — |
| 素材管理 | 素材库、物料库、手动合成（占位）、自动合成（占位） | — |
...
| 文档 | 说明 |
|------|------|
| [`文档/AI创作-PRD.md`](文档/AI创作-PRD.md) | AI 创作模块 PRD，覆盖通用生成、我的任务、全部图片、项目管理、工作流-裂变 5 个页面的功能说明、状态说明、数据说明与操作边界 |

> 开发 AI 创作模块页面前请先阅读对应 PRD。
